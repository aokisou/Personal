...
void Scene::Reset()
{
	...
	m_nodeList[m_num.x][m_num.y]->h = dx + dy;
	m_nodeList[m_num.x][m_num.y]->score = dx + dy;
	m_bOK = false;
}
...
void Scene::Init()
{
	...
	m_nodeList[startX][startY]->h = dx + dy;
	m_nodeList[startX][startY]->score = dx + dy;
